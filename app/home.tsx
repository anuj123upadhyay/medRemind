...
const QUICK_ACTIONS = [
  {
    ...
    color: "#2E7D32",
    gradient: ["#e8647e", "#e8647e"] as [string, string],
  },
  {
    ...
    color: "#1976D2",
    gradient: ["#65b5f7", "#65b5f7"] as [string, string],
  },
  {
    ...
    color: "#C2185B",
    gradient: ["#87f765", "#87f765"] as [string, string],
  },
  {
...
export default function HomeScreen() {
  ...
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      <LinearGradient colors={["#e66578", "#fa3c78"]} style={styles.header}>
